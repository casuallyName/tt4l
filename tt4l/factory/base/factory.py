...
from transformers import (trainer_utils, TrainingArguments, Trainer,
                          ...
                          PreTrainedTokenizer, PretrainedConfig, PreTrainedModel, AutoModelForTokenClassification,
                          )
...
class _BaseTaskModelFactory:
    ...
    def _load_sequence_classification_model(
            self,
            training_args: TrainingArguments,
            task_args: Union[BaseTaskArguments, BasePredictArguments],
            config: PretrainedConfig,
    ...
    def _load_token_classification_model(
            self,
            training_args: TrainingArguments,
            task_args: Union[BaseTaskArguments, BasePredictArguments],
            config: PretrainedConfig,
