...
class ModelingBertTestCase(BaseTestCase):
    ...
    def test_BertForMultiLabelSequenceClassification(self):
        ...
        model = BertForMultiLabelSequenceClassification(self.bert_config(pool_strategy='first_last_avg'))
    ...
    def test_BertForSequenceClassification(self):
        ...
        model = BertWithHiddenPoolingForSequenceClassification(self.bert_config(pool_strategy='first_last_avg'))
    ...
    def test_BertWithCrfForTokenClassification(self):
        ...
        model = BertWithCrfForTokenClassification(self.bert_config(num_labels=3))
    ...
    def test_BertForEntitySpanClassification(self):
        ...
        model = BertForEntitySpanClassification(self.bert_config(num_labels=3))
